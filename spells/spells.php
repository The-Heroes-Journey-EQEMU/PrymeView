...
include $_SERVER['DOCUMENT_ROOT'] . '/thj/includes/spell.inc.php';
include $_SERVER['DOCUMENT_ROOT'] . '/thj/includes/constants.php';
include $_SERVER['DOCUMENT_ROOT'] . '/thj/includes/functions.php';
